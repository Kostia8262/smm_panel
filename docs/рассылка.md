...
**Состояние на 13.09.2026:** фаза 1 «Базы» сделана и выкачена (`30faf32`,
`7c2094a`, `2f577ae`). Фаза 2 «Ящик и отписка» сделана, проверена в браузере на
подделанном Google; боевое подключение ящика — после выкатки. Ящик-отправитель:
...
| Адрес | Экран |
|---|---|
| `#/mail` | **Базы** школы (фаза 1). С фазы 3 здесь встанут вкладки, и первой станут **Рассылки** — состояние словом, тема, базы, прогресс «1 240 из 3 000», прогноз окончания; тревога, если ящик мёртв |
...
| `#/mail/campaign/:id` | **Редактор** (фаза 3) — слева блоки, справа предпросмотр; ниже аудитория с расчётом, время, проверки (блокеры отдельно от предупреждений), «Пробное себе», «На согласование» или «Утвердить» |
...
### Фаза 1 — Базы · сделана 13.09.2026, не выкачена
