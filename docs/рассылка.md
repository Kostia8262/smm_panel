...
**Состояние на 13.09.2026:** фаза 1 «Базы» сделана (сервер — `30faf32`, экраны —
следующим коммитом), на боевой сервер не выкачена. Ящик-отправитель выбран:
обычный @gmail.com (адрес в репозиторий не пишем — он придёт в базу при
подключении кнопкой), значит потолок Google 500 получателей за 24 часа, экран
согласия — External + In production.
