...
export const api = {
  ...
  crmAccessKeys: () => request('/api/settings/crm-access'),
  issueCrmAccessKey: (body) => request('/api/settings/crm-access', { method: 'POST', body }),
  revokeCrmAccessKey: (id) => request(`/api/settings/crm-access/${id}/revoke`, { method: 'POST' }),
