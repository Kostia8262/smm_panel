...
- **Форма подписки на сайтах — сделано и выкачено 14.09** (`src/mail/signups.js`,
  ...
  - **Блок в подвалах** (репозитории сайтов): хаб mycomputer.education (10 подвалов),
    webdesign, mycomputer.school и лендинги .school, child (Django, прокси
    ...
    **Не сделано:** python, roblox, minecraft — замер схлопывания до конца сентября
    (правило владельца «лендинги не трогать»). Галочка согласия в формах заявок — нет.
